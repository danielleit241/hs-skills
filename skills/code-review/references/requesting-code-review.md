...
```
Before dispatching code-reviewer, invoke /hs:scout to find:
...
- Report Critical issues with evidence; hand off remediation only after explicit authorization.
- Hand off Important issues for explicitly authorized remediation before proceeding.
...
- Hand off remediation before moving to the next task when the user authorizes it.
