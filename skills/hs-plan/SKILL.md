...
After creating a plan, update active-plan state only when the current platform provides such a mechanism; the plan itself remains in the configured artifact directory.
