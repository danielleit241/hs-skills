...
Read root `.hs.json` before creating output. Use `artifacts.repomix.directory` as the default destination for generated packs; an explicit `-o` path overrides it.
